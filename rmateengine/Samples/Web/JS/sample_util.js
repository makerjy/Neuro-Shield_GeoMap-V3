...
function frameUnLoadHandler(event){
	...
	demoEvent(remove, _$("updaterTab"), "click", tabMouseHandler);
...
function addEventHandler(){
	...
	demoEvent(add, _$("updaterTab"), "click", tabMouseHandler);
...
function changeTab(elem){
	...
	if(elem === sourceTab && !elem._highlightInit && (elem._highlightInit = true)){
		...
		_$("updaterTareaSource").innerHTML = script.text.replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/\r/g, "").replace(/\t/g, "&nbsp;&nbsp;&nbsp;&nbsp;").replace(/\n/g, "<br>");
